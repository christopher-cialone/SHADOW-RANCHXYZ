...
export default function HomeMobile() {
  ...
  return (
    <div className="space-y-8 sm:space-y-12">
      ...
      <section className="min-h-[80vh] flex items-center justify-center relative px-4">
        ...
        <div className="text-center relative z-10 max-w-md sm:max-w-2xl mx-auto">
          <div className="animate-fade-in space-y-6 sm:space-y-8">
            <h1 className="font-data70 text-mobile-3xl sm:text-4xl md:text-6xl lg:text-8xl text-tech-cyan-400 font-bold tracking-wider leading-tight">
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 sm:justify-center">
              <Link href="/cypherpunks-ethos">
                <TechButton variant="primary" size="lg" className="w-full sm:w-auto bg-gradient-to-r from-tech-cyan-600 to-tech-purple-600 hover:from-tech-cyan-500 hover:to-tech-purple-500">
              ...
              <Link href="/lessons">
                <TechButton variant="secondary" size="lg" className="w-full sm:w-auto">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-8 sm:py-12 lg:py-20">
        <div className="space-y-8 sm:space-y-12">
          <div className="text-center space-y-4">
            <h2 className="font-data70 text-mobile-2xl sm:text-3xl md:text-4xl lg:text-5xl text-tech-cyan-400">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <TechCard variant="cyan" className="hover:scale-105 transition-transform duration-200 animate-slide-up">
              <div className="text-center space-y-4">
                <svg className="w-12 h-12 text-tech-cyan-400 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
                <h3 className="font-mono text-mobile-xl text-tech-cyan-400 font-bold">Interactive Coding</h3>
            ...
            <TechCard variant="purple" className="hover:scale-105 transition-transform duration-200 animate-slide-up">
              <div className="text-center space-y-4">
                <svg className="w-12 h-12 text-tech-purple-400 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                <h3 className="font-mono text-mobile-xl text-tech-purple-400 font-bold">NFT Rewards</h3>
                <p className="text-gray-300 text-mobile-sm leading-relaxed">
            ...
            <TechCard variant="pink" className="hover:scale-105 transition-transform duration-200 animate-slide-up sm:col-span-2 lg:col-span-1">
              <div className="text-center space-y-4">
                <svg className="w-12 h-12 text-tech-pink-400 mx-auto" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
                </svg>
                <h3 className="font-mono text-mobile-xl text-tech-pink-400 font-bold">Gamified Learning</h3>
                <p className="text-gray-300 text-mobile-sm leading-relaxed">
      ...
      {ranchData && (
        <section className="py-8 bg-tech-purple-900/20 rounded-xl mx-4 sm:mx-0">
          <div className="text-center space-y-6">
            <h2 className="font-data70 text-mobile-xl sm:text-2xl text-tech-cyan-400">
              Your Progress
            </h2>
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="text-mobile-2xl sm:text-3xl font-bold text-tech-cyan-400">
                  {formatRanchCoin(ranchData.coins)}
                </div>
                <div className="text-mobile-sm text-gray-400 font-mono">Ranch Coins</div>
              </div>
              <div className="text-center">
                <div className="text-mobile-2xl sm:text-3xl font-bold text-tech-purple-400">
                  {ranchData.experience}
                </div>
                <div className="text-mobile-sm text-gray-400 font-mono">Experience</div>
              </div>
              <div className="text-center">
                <div className="text-mobile-2xl sm:text-3xl font-bold text-tech-pink-400">
                  {ranchData.level}
                </div>
              ...
              <div className="text-center">
                <div className="text-mobile-2xl sm:text-3xl font-bold text-tech-cyan-400">
                  {ranchData.buildingsOwned?.length || 0}
                </div>
      ...
      <section className="py-8 sm:py-12 text-center space-y-6">
        <h2 className="font-data70 text-mobile-2xl sm:text-3xl md:text-4xl text-tech-cyan-400">
